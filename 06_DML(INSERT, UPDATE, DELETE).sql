...
INSERT INTO EMPLOYEE2 VALUES(900, '장채현', '901123-2345678', 'jang_ch@kh.or.kr', '01012341234','D1', 'J7', 'S3', 4300000, 0.2, 200, SYSDATE, NULL, 'N');
...
-- BONUS를 0.1로 변경
UPDATE EMPLOYEE2 
SET BONUS = 0.1 WHERE BONUS IS NULL;
...
SELECT EMP_NAME, SALARY, BONUS FROM EMPLOYEE2 WHERE EMP_NAME IN ('노옹철','전형돈','정중하','하동운');
...
-- EMPLOYEE2 테이블 전체 삭제(WHERE절 없이 작성)
